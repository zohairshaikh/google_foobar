...
def get_corresponding_char(char):
    ...
    # check if passes value is lower cased ascii character. Else return as it is
    if 123 > o > 96:
...
def solution(statement="Yvzs! I xzm'g yvorvev Lzmxv olhg srh qly zg gsv xlolmb!!"):
    output = ''
    for char in statement:
        output += (get_corresponding_char(char))
